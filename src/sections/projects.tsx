    ...
    <div id="projects" className="w-full my-32">
      ...
      <div className="flex flex-col gap-4 mb-6 mt-4">
        {projectsData.projects.map((project) => (
          <div
            key={project.id}
            className="flex flex-row items-center border p-4 gap-x-8 rounded"
          >
            <img
            ...
            <div className="flex flex-row items-center justify-between w-full">
              <div className="flex flex-col justify-between">
                ...
                <p className="font-light text-white/70 pb-6">
                  {project.description}
                </p>
      ...
      <div className="w-full flex items-center justify-center">
        <Link
          to="/projects"
          className="px-8 py-4 mx-auto rounded-md bg-black active:scale-90 duration-200 text-white"
        >
          {" "}
          More projects{" "}
        </Link>
